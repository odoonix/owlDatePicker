...
export function makeEnv() {
    return {
        bus: new EventBus(),
        services: {},
        debug: false, // odoo.debug,
        _t: (value) => {
            return value;
            // TODO: maso, 2023: replace with a real translation function
...
let startServicesPromise: Promise<any> | undefined = undefined;
...
export async function startServices(env) {
    ...
    serviceRegistry.addEventListener("UPDATE", async (ev: any) => {
